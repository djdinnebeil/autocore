...
| `auto_core.core.component` | [`component.ixx`](../app/core/modules/component.ixx) | Per-component logging, console output, and text insertion |
...
| `auto_core.main.keymap` | [`keymap.ixx`](../app/main/modules/keymap.ixx) | Active primary/secondary key bindings |
| `auto_core.main.keymap.runtime` | [`keymap_runtime.ixx`](../app/main/modules/keymap_runtime.ixx) | File keymap, command registry, workspace files |
| `auto_core.main.logger` | [`logger_init.ixx`](../app/main/modules/logger_init.ixx) | Starts and stops `logger_ac.exe` from Main |
| `auto_core.main.program_ready` | [`program_ready.ixx`](../app/main/modules/program_ready.ixx) | Startup status output |
| `auto_core.main.shutdown_events` | [`shutdown_events.ixx`](../app/main/modules/shutdown_events.ixx) | Console and session shutdown |
| `auto_core.main.taskbar` | [`main_taskbar.ixx`](../app/main/modules/main_taskbar.ixx) | Interactive cycling session owned by Main |
| `auto_core.main.test_commands` | [`test_commands.ixx`](../app/main/modules/test_commands.ixx) | Diagnostic keymap commands |
...
| Module | Source | Role |
| --- | --- | --- |
| `itunes_client` | [`itunes_client.ixx`](../app/components/itunes/itunes_client.ixx) | COM client and shared iTunes process state |
| `itunes_component` | [`itunes_component.ixx`](../app/components/itunes/itunes_component.ixx) | `itunes_ac.exe` Component session |
| `itunes_monitor` | [`itunes_monitor.ixx`](../app/components/itunes/itunes_monitor.ixx) | Track-change monitor |
| `itunes_pipe` | [`itunes_pipe.ixx`](../app/components/itunes/itunes_pipe.ixx) | Pipe command registration |
| `itunes_registry` | [`itunes_registry.ixx`](../app/components/itunes/itunes_registry.ixx) | iTunes runtime command registry |
| `itunes_removal` | [`itunes_removal.ixx`](../app/components/itunes/itunes_removal.ixx) | Recycle-bin track removal |
| `itunes_runtime` | [`itunes_runtime.ixx`](../app/components/itunes/itunes_runtime.ixx) | Testable playback and lifecycle boundaries |
| `journal_clock` | [`journal_clock.ixx`](../app/components/journal/journal_clock.ixx) | Journal day-rollover timestamp |
| `journal_cloud` | [`journal_cloud.ixx`](../app/components/journal/journal_cloud.ixx) | Optional Firebase sync |
| `journal_commands` | [`journal_commands.ixx`](../app/components/journal/journal_commands.ixx) | Journal runtime command registry |
| `journal_component` | [`journal_component.ixx`](../app/components/journal/journal_component.ixx) | `journal_ac.exe` Component session |
| `journal_database` | [`journal_database.ixx`](../app/components/journal/journal_database.ixx) | `journals.db` series, counters, Firebase URL |
| `journal_title` | [`journal_title.ixx`](../app/components/journal/journal_title.ixx) | Episode title and new-file workflow |
| `log_init` | [`log_init.ixx`](../app/components/logger/log_init.ixx) | `logger_ac.exe` startup logging |
| `logger_state` | [`logger_state.ixx`](../app/components/logger/logger_state.ixx) | Logger process state |
| `main_log` | [`main_log.ixx`](../app/components/logger/main_log.ixx) | Writes decoded central-log events |
| `server_logging` | [`server_logging.ixx`](../app/components/server/server_logging.ixx) | `server_ac.exe` Component logging |
| `music` | [`music.ixx`](../app/components/slash/music.ixx) | Recycled music-file naming |
| `path_utils` | [`path_utils.ixx`](../app/components/slash/path_utils.ixx) | Path stem and extension helpers |
| `spotify_client` | [`spotify_client.ixx`](../app/components/spotify/spotify_client.ixx) | Spotify Web API client state |
| `spotify_component` | [`spotify_component.ixx`](../app/components/spotify/spotify_component.ixx) | `spotify_ac.exe` Component session |
| `spotify_http` | [`spotify_http.ixx`](../app/components/spotify/spotify_http.ixx) | HTTP status helpers |
| `spotify_monitor` | [`spotify_monitor.ixx`](../app/components/spotify/spotify_monitor.ixx) | Playback monitor |
| `spotify_pipe` | [`spotify_pipe.ixx`](../app/components/spotify/spotify_pipe.ixx) | Pipe command registration |
| `spotify_registry` | [`spotify_registry.ixx`](../app/components/spotify/spotify_registry.ixx) | Spotify runtime command registry |
| `spotify_oauth` | [`spotify_oauth.ixx`](../app/components/spotify_oauth/spotify_oauth.ixx) | OAuth authorization and device registration |
| `spotify_oauth_paths` | [`spotify_oauth_paths.ixx`](../app/components/spotify_oauth/spotify_oauth_paths.ixx) | OAuth executable directory |
| `taskbar_commands` | [`taskbar_commands.ixx`](../app/components/taskbar/taskbar_commands.ixx) | `taskbar_ac.exe` command registration |
| `taskbar_logging` | [`taskbar_logging.ixx`](../app/components/taskbar/taskbar_logging.ixx) | `taskbar_ac.exe` logging |
| `wake_logging` | [`wake_logging.ixx`](../app/components/wake/wake_logging.ixx) | Wake event logging via `powercfg /lastwake` |
| `writer_commands` | [`writer_commands.ixx`](../app/components/writer/writer_commands.ixx) | Writer runtime command registry |
| `writer_component` | [`writer_component.ixx`](../app/components/writer/writer_component.ixx) | `writer_ac.exe` Component session |
