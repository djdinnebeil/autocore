...
| Simple test | [`app/components/simple_test/simple_test.sln`](../app/components/simple_test/simple_test.sln) |
...
| Main | [`app/main/vs/auto_core_main_tests.vcxproj`](../app/main/vs/auto_core_main_tests.vcxproj) |
...
iTunes and Spotify test notes: [`app/components/itunes/TESTING.md`](../app/components/itunes/TESTING.md), [`app/components/spotify/TESTING.md`](../app/components/spotify/TESTING.md). `build-all.ps1` does not build tests. Test `OutDir` is `obj\<project>\`. From the repository root, Release x64:
...
msbuild app\main\vs\auto_core_main_tests.vcxproj /m /p:Configuration=Release /p:Platform=x64
...
Application `OutDir` is `dist\`. The core DLL `OutDir` is `lib\`. `IntDir` is `obj\<project>\`.
