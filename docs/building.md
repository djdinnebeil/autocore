...
There is no root `.sln`. Nested children live under `app/components/<name>/main` and `config` (Spotify also `oauth`). Each of those folders has its own `.sln`. Open these Visual Studio solutions:

| Project | Solution |
| --- | --- |
| Core DLL | [`app/core/vs/auto_core_dll.sln`](../app/core/vs/auto_core_dll.sln) |
| Main executable | [`app/main/component/vs/auto_core.sln`](../app/main/component/vs/auto_core.sln) |
| Auto Core config | [`app/main/config/auto_core_config/auto_core_config.sln`](../app/main/config/auto_core_config/auto_core_config.sln) |
| Main config | [`app/main/config/main_config/main_config.sln`](../app/main/config/main_config/main_config.sln) |
| Components config | [`app/main/components/config/components_config.sln`](../app/main/components/config/components_config.sln) |
| Components editor | [`app/main/components/editor/components_editor.sln`](../app/main/components/editor/components_editor.sln) |
| Keymap config | [`app/main/keymap/config/keymap_config.sln`](../app/main/keymap/config/keymap_config.sln) |
| Keymap editor | [`app/main/keymap/editor/keymap_editor.sln`](../app/main/keymap/editor/keymap_editor.sln) |
| Shutdown config | [`app/main/config/shutdown_config/shutdown_config.sln`](../app/main/config/shutdown_config/shutdown_config.sln) |
| Crash recovery config | [`app/main/config/crash_recovery_config/crash_recovery_config.sln`](../app/main/config/crash_recovery_config/crash_recovery_config.sln) |
...
| Main | [`app/main/component/vs/auto_core_main_tests.vcxproj`](../app/main/component/vs/auto_core_main_tests.vcxproj) |
...
msbuild app\main\component\vs\auto_core_main_tests.vcxproj /m /p:Configuration=Release /p:Platform=x64
...
From the repository root, Release x64, run [`scripts/build-all.ps1`](../scripts/build-all.ps1). That script lists every nested `main` / `config` / `oauth` solution. Build the DLL before any executable that links `auto_core.lib`, or use the tracked `lib/auto_core.lib`. The linker searches `lib/`.
