 ...
 * reporting failures and routing the resulting message. Unexported
 * `normalize_argument` converts `std::filesystem::path` and wide text to
 * UTF-8 before `std::vformat`.
 */
export module auto_core.core.formatting;
