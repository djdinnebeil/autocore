...
void spotify_get_queue() {
    spotify_component.logg_and_logg("spotify_get_queue()");
    std::string user_queue = ac_spotify.get_user_queue();
    spotify_component.logg_and_print(user_queue);
...
void spotify_print_songs() {
    spotify_component.logg_and_logg("spotify_print_songs()");
...
void spotify_play_pause() {
    spotify_component.logg_and_logg("spotify_play_pause()");
...
void spotify_switch_player() {
    spotify_component.logg_and_logg("spotify_switch_player()");
