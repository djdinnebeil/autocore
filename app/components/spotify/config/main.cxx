...
int main(int argc, char* argv[]) {
    ...
    if (std::filesystem::exists(path, error)) {
        ...
        return ac::config::components_request::run_component_update("spotify");
    }
    ...
    std::cout << "Spotify application data directory [.\\"
    ...
    if (!write_bytes(
            ...
            spotify::defaults::ini_for(
                directory.empty() ? spotify::defaults::directory : directory
            )
        )) {
        return 1;
    }
