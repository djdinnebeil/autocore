...
void print_next_up_song_list() {
    itunes_component.log_main("print_next_up_song_list()");
...
void itunes_play_pause() {
    itunes_component.log_main("itunes_play_pause()");
    itunes::runtime::play_pause(ac_itunes);
}

void itunes_prev_song() {
    itunes_component.log_main("itunes_prev_song()");
    itunes::runtime::previous_song(ac_itunes);
}

void itunes_stop_song() {
    itunes_component.log_main("itunes_stop_song()");
...
void print_itunes_songs() {
    itunes_component.log_main("print_itunes_songs()");
