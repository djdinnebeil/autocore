...
TEST_CASE("Unbound keymap line is key = primary | secondary", "[keymap-map][unit]") {
    const auto line = ac::keymap::map_file::format_line("numpad_2", {}, {});
    CHECK(line == "numpad_2 = primary | secondary\n");
...
TEST_CASE("Fully unset input formats as primary | secondary", "[keymap-map][unit]") {
