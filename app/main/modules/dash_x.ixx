/**
\file dash_x.ixx
\brief This module augments dash.ixx for keymap configuration.
...
/**
* \brief Resolves a keymap command name to an executable action.
* \param function_name The keymap command name or supported command expression.
*
* \note This command registry is automatically generated by the dash component.
* Functions marked with \keymap_command are added to the registry. Parameterized
* commands such as make_print_choice() may be handled separately.
*
* \return The resolved action, or an empty std::function if the command is not found.
*/
export std::function<void()> get_function_by_name(std::string_view function_name) {
    static const std::unordered_map<std::string_view, std::function<void()>> function_map = {
        ...
        {"print_extended_timestamp", &print_extended_timestamp},
        {"print_date_iso", &print_date_iso},
        {"print_date_compact", &print_date_compact},
        {"print_date_iso_with_timestamp", &print_date_iso_with_timestamp},
        {"print_date_iso_with_timestamp_w", &print_date_iso_with_timestamp_w},
        {"add_brackets_around_clipboard", &add_brackets_around_clipboard},
        {"send_alt_f12", &send_alt_f12},
        {"print_and_insert_special_utf8", &print_and_insert_special_utf8},
        {"print_and_insert_special_utf16", &print_and_insert_special_utf16},
        {"print_and_insert_testing", &print_and_insert_testing},
        {"send_crash_command", &send_crash_command},
